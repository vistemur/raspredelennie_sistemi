Thank you for downloading Eclipse GlassFish 6.2.5!
...
Make sure to also check the GlassFish 6.2.5 Documentation contains important information : https://glassfish.org/docs/#current
